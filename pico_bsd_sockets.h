...
void                        pico_bsd_deinit(struct pico_stack *stack);
void                        pico_bsd_stack_tick(struct pico_stack *s);
void                        pico_bsd_stack_tick_timeout(struct pico_stack *s, int timeout_ms);
uint16_t                    pico_bsd_select(struct pico_bsd_endpoint *ep);
void                        pico_bsd_set_posix_fd(int sockfd, int posix_fd);
